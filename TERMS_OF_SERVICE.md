...
- Displays astrological cycles and planetary transits
- Offers astrological interpretations and guidance

## User Responsibilities

You agree to:

- Provide accurate birth information for accurate astrological calculations
...
- kaira provides **astrological interpretations for entertainment and self-reflection purposes only**
- The app's insights, predictions, and guidance should **not be considered professional advice**
- Do not make major life decisions (medical, financial, legal, etc.) based solely on astrological information
- Always consult qualified professionals for serious matters

### Accuracy

- We strive for accuracy in astronomical calculations and astrological interpretations
- However, we make no guarantees about the accuracy, completeness, or reliability of any content
- Astrological interpretations are subjective and may vary among practitioners
...
- All content, features, and functionality of kaira are owned by the developers
- Astrological calculations are based on publicly available astronomical data
- You may not copy, modify, distribute, or create derivative works without permission

## Data and Privacy

- Your birth information is stored **locally on your device only**
- We do not collect, transmit, or store your personal information on any servers
...
3. Small claims court (for applicable disputes)
